...
function mostraResultado() {
    if (Object.keys(contagemAfirmacoes).length > 0) {
        caixaPerguntas.innerHTML = '<a class="clique2" href="https://anabarros-22.github.io/ana.2t.3b/">Reiniciar Teste</a> Parabéns pela tentativa. De 10 questões, você acertou: ';
